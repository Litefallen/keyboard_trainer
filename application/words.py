...
def word_freq_sort(): # sort words by most frequent letter
    ...
    with open('./application/words_dictionary.json', 'r') as file: #Change the path according to your settings
        ...
        with open('./application/sorted_words.json','w') as file: # create json file with sorted letters. Change the path according to your settings
